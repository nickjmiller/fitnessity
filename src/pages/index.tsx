        ...
        <>
            ...
            <Box hidden={hidden}>
                ...
                <Flex flexWrap="wrap" justifyContent="space-around" maxWidth={768} margin="auto">
                    <Button variant="Primary" onClick={() => setWorkoutPlan(shuffleExercises(["Upper", "Upper", "Upper", "Upper", "Core"]))}>
                        Upper!
                    </Button>
                    <Button variant="Primary" onClick={() => setWorkoutPlan(shuffleExercises(["Lower", "Lower", "Lower", "Lower", "Core"]))}>
                        Lower!
                    </Button>
                    <Button variant="Primary" onClick={() => setWorkoutPlan(shuffleExercises([...DEFAULT_WORKOUT_PLAN]))}>
                        Balanced!
                    </Button>
